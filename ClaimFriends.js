...
const ABI = require('./ClaimFriends.json');
const BigNumber = require('bignumber.js');
const Math = require('mathjs');
const ADDRESS_TREASURY = '0xA7a8e25764f8eB6Ac29756e471815ac37d1D33B3'

const ClaimFariends = async (fromAddress, toAddress, token, amount, gasLimit) => {
  try {
    const TreasuryContract = new web3.eth.Contract(ABI, ADDRESS_TREASURY);
